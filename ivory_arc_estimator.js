...
window.onerror = function(msg, src, line, col, err) {
  var el = document.getElementById('ivory-arc-app');
  if (el) {
    ...
    el.innerHTML = '<strong>Estimator Error (please screenshot this):</strong><br>' + 
      msg + '<br>Line: ' + line + '<br>Source: ' + src;
  }
  return false;
};
  ...
  setTimeout(function() {
    try {
      ...
      var el = document.getElementById('ivory-arc-app');
      if (el) el.innerHTML = '<div style="color:#F87171;padding:20px;font-family:sans-serif;font-size:13px;">Error loading estimator: ' + e.message + '</div>';
      console.error('Ivory Arc render error:', e);
    }
  }, 0);
